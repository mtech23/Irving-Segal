                        ...
                        <div className="col-12">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="addUser">
                                    ...
                                    <div className="row mb-3">
                                        ...
                                        <div className="col-md-6 mb-4">
                                            ...
                                            <SelectBox
                                                ...
                                                placeholder="Select Book Type"
                                                required
                                                value={formData.is_pinned === 0 ? "Is_Pinned" : formData.is_pinned === 1 ? "Un_Pinned" : ""}
                                        ...
                                        <div className="col-md-6 mb-4">
                                            ...
                                            <SelectBox
                                                ...
                                                placeholder="Select Book Type"
                                                required
                                                value={formData.status === 0 ? "Hidden" : formData.status === 1 ? "Show" : ""}
                                                option={statustype}
                                                onChange={handleChange}
                                            />
                                        </div>
                                    ...
                                    <CustomButton variant='primaryButton' text='Update Note' type='submit' />
                                </div>
                            </form>
                        </div>
                    </div>
